...
//轨颚水平裂纹、轨头水平裂纹、轨腰水平裂纹、纵向裂纹、FG失波：可能有轨面缺陷/水平裂纹/斜裂纹/纵向裂纹
...
uint8_t	GetWoundRect2(Wound_Judged& wound, uint8_t iJawRow, TRECT* rect, uint8_t isFold  = 0 );//Wound_Judged导出伤损数据 TRECT（step1、step2、row1、row2）
